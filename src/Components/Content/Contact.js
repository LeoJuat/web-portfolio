...
const Contact = ({ contactRef, contactIsIntersecting }) => {
  ...
  return (
    <section className="pt-24 sm:pt-16 justify-center text-[#f1f3f5] w-3/4 mx-auto h-[100vh]">
      <h3
        ref={contactRef}
      ...
      <div
        ref={linksRef}
        className={`flex justify-center gap-5 sm:gap-10 pt-14 transition-all pb-10 ${
      ...
      >
        ...
        <a
          href={
            "https://drive.google.com/file/d/1kVfp5EYiJp_ZfslpNLruNVIhI4y5hlAF/view?usp=sharing"
          }
          target="_blank"
          rel="noreferrer"
