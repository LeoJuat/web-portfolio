...
import styles from "./SocialMediaProject.module.css";
import SocialMediaSlides from "./SocialMediaSlides";
    ...
    <div className={`${cardIsIntersecting && styles.card}`}>
      ...
      >
        ...
        <h2 className="text-[#868e96] text-base tracking-wider mb-5">
          ...
          <span className="text-[#fcc419] text-lg">|</span> Firestore Database{" "}
          <span className="text-[#fcc419] text-lg">|</span> Rapid API{" "}
        </h2>
        <SocialMediaSlides cardIsIntersecting={cardIsIntersecting} />
      </Card>
      <div className={`flex gap-5 transition-all pl-8`}>
        <a
          href={"https://showerthoughts.social/"}
          target="_blank"
          rel="noreferrer"
        ...
        <a
          href={"https://github.com/LeoJuat/showerthoughts"}
          target="_blank"
          rel="noreferrer"
          className="px-2 py-2 rounded-lg shadow-sm bg-[#fcc419] hover:scale-105 duration-200 ease-in-out shadow-[#fcc419] hover:bg-[#dcae22] text-[#f1f3f5] font-semibold"
        >
